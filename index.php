        ...
        <div class="fb-home-timeline">
          ...
          <div class="user-post">
            <div class="user-post-header">
              <div class="post-info">
                <img src="<?php echo $facebookPost['user']['profile_image'] ?>" alt="" />
                <div class="user-details">
                  <a class="author" href="#"><?php echo $facebookPost['user']['name'] ?></a>
                  <span
                    >10m
                    <svg
                      fill="currentColor"
            ...
            <div class="post-body">
              <div class="post-content">
                <p>
                  <?php echo $facebookPost['caption'] ?>
                </p>
              </div>
            </div>
            <div class="post-media">
              <img
                src="<?php  echo $facebookPost['image']?>"
                alt=""
              />
            </div>
